...
if (Config.WORKTYPE == 'private') {
    ...
    Aqua.addCommand({pattern: 'removebg ?(.*)', fromMe: true, desc: Lang.REMOVEBG_DESC,  deleteCommand: false }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,fs.readFileSync('rbg.png'), MessageType.document, {filename: '😈MznBots😈.png', mimetype: Mimetype.png, quoted: message.data});
        await load.delete();
    }));
}
